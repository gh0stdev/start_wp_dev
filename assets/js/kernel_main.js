; /* /bitrix/js/main/json/json2.min.js?14997573613467*/
; /* /bitrix/js/main/core/core_ls.min.js?14997573607365*/
; /* /bitrix/js/main/session.min.js?14997573602511*/
; /* /bitrix/js/main/utils.min.js?149975736019858*/
; /* /bitrix/js/main/core/core_fx.min.js?14997573609768*/
; /* /bitrix/js/main/core/core_window.min.js?152469622875173*/
; /* /bitrix/js/main/core/core_date.min.js?152469614037561*/
; /* /bitrix/js/main/core/core_popup.min.js?152469614240695*/
; /* /bitrix/js/main/core/core.min.js?152469640576842*/
; /* /bitrix/js/main/core/core_ajax.min.js?152469640522949*/

; /* Start:"a:4:{s:4:"full";s:48:"/bitrix/js/main/core/core.min.js?152469640576842";s:6:"source";s:28:"/bitrix/js/main/core/core.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
        ...
        t.prototype = {
            set: function (e, t) {
                ...
                if (n && n[0] === e) {
                    ...
                    Object.defineProperty(e, this.name, {value: [e, t], writable: true})
                }
                return this
            }, get: function (e) {
                if (!this.isValid(e)) {
...
(function (window) {
    ...
    var __readyHandler = null, readyBound = false, readyList = [], proxyList = new WeakMap, deferList = new WeakMap,
        NODECACHE = {}, deniedEvents = [], eventsList = new WeakMap, customEvents = new WeakMap, customEventsCnt = 0,
        garbageCollectors = [], cssList = [], cssInit = false, jsList = [], jsInit = false,
    ...
    BX.browser = {
        IsIE: function () {
            ...
            if (e.exec(navigator.userAgent) != null) return parseFloat(RegExp.$1); else return 0
    ...
    BX.processHTML = function (e, t) {
        ...
        while ((n = r.script.exec(e)) !== null) {
            ...
            if (p) {
                ...
                if ((o = n[1].match(r.script_src)) !== null) {
                    ...
                    l.push({bRunFirst: h, isInternal: true, JS: B})
                }
            }
            c = d.index + 9;
        ...
        return {HTML: y, SCRIPT: l, STYLE: u}
    };
    ...
    BX.pos = function (e, t) {
        ...
        if (typeof e.getBoundingClientRect != "undefined" && e.ownerDocument == document && !t) {
            ...
            var s = 0, a = 0, l = e.offsetWidth, u = e.offsetHeight;
            var f = true;
            for (; e != null; e = e.offsetParent) {
                ...
                var c = parseInt(BX.style(e, "border-left-width")), d = parseInt(BX.style(e, "border-top-width"));
                if (!isNaN(c) && c > 0) s += c;
                if (!isNaN(d) && d > 0) a += d
            }
            n.top = a;
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:53:"/bitrix/js/main/core/core_ajax.min.js?152469640522949";s:6:"source";s:33:"/bitrix/js/main/core/core_ajax.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
(function (e) {
    if (e.BX.ajax) return;
    var a = e.BX, t = {}, r = {
        method: "GET",
    ...
    a.ajax = function (e) {
        ...
        t = {};
        for (n in r) if (typeof e[n] == "undefined") e[n] = r[n];
        ...
        if (l) {
            ...
            var d = false;
            var h = e.xhr.onreadystatechange = function (t) {
                if (d) return;
                if (t === "timeout") {
                    if (e.onfailure) {
                        e.onfailure("timeout")
    ...
    a.ajax.__prepareOnload = function (t) {
        if (t.length > 0) {
            ...
            for (var r = 0, i = t.length; r < i; r++) {
                if (t[r].isInternal) {
                    t[r].JS = t[r].JS.replace(s.script_onload, "BX.ajax.onload_" + o)
                }
            }
        }
        a.CaptureEventsGet();
        ...
        switch (t.dataType.toUpperCase()) {
            case"JSON":
                ...
                if (!!r && a.type.isArray(r["bxjs"])) {
                    for (var s = 0; s < r["bxjs"].length; s++) {
                        if (a.type.isNotEmptyString(r["bxjs"][s])) {
                            i.push({isInternal: false, JS: r["bxjs"][s], bRunFirst: t.scriptsRunFirst})
                        } else {
                            i.push(r["bxjs"][s])
                        }
                    }
                ...
                break;
            case"SCRIPT":
                i.push({isInternal: true, JS: e, bRunFirst: t.scriptsRunFirst});
                r = e;
                break;
            default:
    ...
    a.ajax.processScripts = function (e, t, r) {
        ...
        for (var n = 0, s = e.length; n < s; n++) {
            ...
            if (e[n].isInternal) i += ";" + e[n].JS; else o.push(e[n].JS)
        }
        ...
        if (a.type.isString(e)) r = e; else if (null != e) {
            for (var o in e) {
                if (e.hasOwnProperty(o)) {
                    if (r.length > 0) r += "&";
                    var i = a.util.urlencode(o);
                    if (t) i = t + "[" + i + "]";
                    if (typeof e[o] == "object") r += a.ajax.prepareData(e[o], i); else r += i + "=" + a.util.urlencode(e[o])
                }
            }
        }
        return r
    ...
    a.ajax.loadScriptAjax = function (e, t, r) {
        if (a.type.isArray(e)) {
            ...
            if (s.script_self_window.test(u) && a.CWindow) return;
            if (s.script_self_admin.test(u) && a.admin) return;
    ...
    var u = function (e) {
        var a = {};
        if (typeof e.analyticsLabel !== "undefined") {
            a.analyticsLabel = e.analyticsLabel
        }
        if (typeof e.mode !== "undefined") {
            a.mode = e.mode
        }
        if (e.navigation && e.navigation.page) {
            a.nav = "page-" + e.navigation.page
        }
        return a
    };
    var l = function (e) {
            ...
            if (!t && a.type.isPlainObject(e) && a.type.isArray(e.errors)) {
                ...
                e.errors.forEach(function (e) {
                    if (e.code === "invalid_csrf" && e.customData.csrf) {
                        a.message({bitrix_sessid: e.customData.csrf});
    ...
    a.ajax.runAction = function (e, t) {
        ...
        var r = u(t);
        r.action = e;
        var o = a.util.add_url_param("/bitrix/services/main/ajax.php", r);
        return c({method: t.method, dataType: "json", url: o, data: t.data, timeout: t.timeout, headers: t.headers})
    };
    a.ajax.runComponentAction = function (e, t, r) {
        ...
        o.c = e;
        o.action = t;
        var i = a.util.add_url_param("/bitrix/services/main/ajax.php", o);
        return c({method: r.method, dataType: "json", url: i, data: r.data, timeout: r.timeout, headers: r.headers})
    };
    a.ajax.load = function (e, t) {
        ...
        for (var i = 0, n = e.length; i < n; i++) {
            switch (e[i].type.toUpperCase()) {
                case"SCRIPT":
                    a.loadScript([e[i].url], a.proxy(o, e[i]));
                    break;
                case"CSS":
                    a.loadCSS([e[i].url]);
                    if (++r >= n) t();
                    break;
                case"JSON":
                    a.ajax.loadJSON(e[i].url, a.proxy(o, e[i]));
                    break;
                default:
                    a.ajax.get(e[i].url, "", a.proxy(o, e[i]));
                    break
            }
        }
    };
    ...
    a.ajax.prepareForm = function (e, a) {
        a = !!a ? a : {};
        var t, r, o, i = [], n = e.elements.length, s = 0, u = 0;
        if (!!e) {
            for (t = 0; t < n; t++) {
                o = e.elements[t];
                ...
                switch (o.type.toLowerCase()) {
                    ...
                    case"hidden":
                    case"select-one":
                        i.push({name: o.name, value: o.value});
                    ...
                    case"file":
                        if (!!o.files) {
                            for (r = 0; r < o.files.length; r++) {
                                s++;
                                i.push({name: o.name, value: o.files[r], file: true});
                                u += o.files[r].size
                            }
                        }
                        break;
                    ...
                    case"select-multiple":
                        for (var l = 0; l < o.options.length; l++) {
                            if (o.options[l].selected) {
                                i.push({name: o.name, value: o.options[l].value});
            ...
            var c = a, f, d, h;
            while (t < i.length) {
                var p = i[t].name.indexOf("[");
                if (p == -1) {
                    c[i[t].name] = i[t].value;
                    c = a;
                    t++
                } else {
                    f = i[t].name.substring(0, p);
                    d = i[t].name.substring(p + 1);
                    h = d.indexOf("]");
                    if (h == -1) {
                        if (!c[f]) c[f] = [];
                        c = a;
                        ...
                        if (!c[f]) c[f] = {};
                        c = c[f];
                        i[t].name = d.substring(0, h) + d.substring(h + 1)
                    }
                }
            }
        }
        return {data: a, filesCount: s, roughSize: u}
    };
        ...
        if (e.SCRIPTS && e.SCRIPTS.length > 0) {
            var t = function (r, o, i) {
                if (!!o && a.type.isArray(o.scripts)) {
                    for (var n = 0, s = e.SCRIPTS.length; n < s; n++) {
                        o.scripts.push({isInternal: false, JS: e.SCRIPTS[n]})
                    }
                } else {
    ...
    a.userOptions.save = function (e, t, r, o, i) {
        if (null == a.userOptions.options) a.userOptions.options = {};
        i = !!i;
        a.userOptions.options[e + "." + t + "." + r] = [e, t, r, o, i];
    ...
    a.userOptions.__get = function () {
        ...
        for (i in a.userOptions.options) {
            if (a.userOptions.options.hasOwnProperty(i)) {
                ...
                var s = o[3];
                if (n === null) {
                    e += "&p[" + t + "][v]=" + a.util.urlencode(s)
                } else {
                    e += "&p[" + t + "][v][" + a.util.urlencode(n) + "]=" + a.util.urlencode(s)
                }
            }
        }
        return e.substr(1)
        ...
        checkRedirectFinish: function (t, r) {
            ...
            a.ready(function () {
                ...
                if (e == "view/" || e == "view%") {
                    ...
                    var s = "/bitrix/tools/ajax_redirector.php?hash=" + o;
                    a.ajax.insertToNode(s, n)
                }
            })
        }
    };
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:54:"/bitrix/js/main/core/core_popup.min.js?152469614240695";s:6:"source";s:34:"/bitrix/js/main/core/core_popup.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
(function (t) {
    "use strict";
    ...
    BX.PopupWindow.prototype.bindAutoHide = function () {
        if (!this.isAutoHideBinded) {
            ...
            if (this.overlay && this.overlay.element) BX.bind(this.overlay.element, "click", BX.proxy(this.close, this)); else BX.bind(document, "click", BX.proxy(this.close, this))
        }
    };
    BX.PopupWindow.prototype.unbindAutoHide = function () {
        if (this.isAutoHideBinded) {
            ...
            if (this.overlay && this.overlay.element) BX.unbind(this.overlay.element, "click", BX.proxy(this.close, this)); else BX.unbind(document, "click", BX.proxy(this.close, this))
        }
    };
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:50:"/bitrix/js/main/core/core_fx.min.js?14997573609768";s:6:"source";s:31:"/bitrix/js/main/core/core_fx.js";s:3:"min";s:35:"/bitrix/js/main/core/core_fx.min.js";s:3:"map";s:35:"/bitrix/js/main/core/core_fx.map.js";}"*/
(function (t) {
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:55:"/bitrix/js/main/core/core_window.min.js?152469622875173";s:6:"source";s:35:"/bitrix/js/main/core/core_window.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
(function (window) {
    ...
    BX.CDialog.prototype.GetParameters = function (t) {
        ...
        for (i = 0; i < o; i++) {
            ...
            switch (r.type.toLowerCase()) {
                ...
                case"select-one":
                    var h = "";
                    if (null == t && e.elements[r.name + "_alt"] && r.selectedIndex == 0) h = e.elements[r.name + "_alt"].value; else h = r.value;
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:53:"/bitrix/js/main/core/core_date.min.js?152469614037561";s:6:"source";s:33:"/bitrix/js/main/core/core_date.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
(function () {
    if (BX.date) return;
    BX.date = {};
    BX.date.format = function (e, t, a, i) {
        ...
        var o = /\\?(sago|iago|isago|Hago|dago|mago|Yago|sdiff|idiff|Hdiff|ddiff|mdiff|Ydiff|yesterday|today|tommorow|tomorrow|[a-z])/gi;
        var l = {
            d: function () {
                return BX.util.str_pad_left(d(s).toString(), 2, "0")
            }, D: function () {
                return BX.message("DOW_" + B(s))
            }, j: function () {
                return d(s)
            }, l: function () {
                return BX.message("DAY_OF_WEEK_" + B(s))
            }, N: function () {
                return B(s) || 7
            }, S: function () {
                if (d(s) % 10 == 1 && d(s) != 11) return "st"; else if (d(s) % 10 == 2 && d(s) != 12) return "nd"; else if (d(s) % 10 == 3 && d(s) != 13) return "rd"; else return "th"
            }, w: function () {
                return B(s)
            }, z: function () {
                var e = new Date(p(s), 0, 1);
                var t = new Date(p(s), h(s), d(s));
                ...
                var e = n ? new Date(Date.UTC(p(s), h(s) + 1, 0)) : new Date(p(s), h(s) + 1, 0);
                return d(e)
            }, L: function () {
                var e = p(s);
                ...
                if (n) return 0;
                var e = new Date(p(s), 0, 1);
                var t = Date.UTC(p(s), 0, 1);
                var a = new Date(p(s), 6, 0);
                var i = Date.UTC(p(s), 6, 0);
                return 0 + (e - t !== a - i)
            }, O: function () {
                if (n) return "+0000";
                ...
                return "Y-m-d\\TH:i:sP".replace(o, g)
            }, r: function () {
                return "D, d M Y H:i:s O".replace(o, g)
            }, U: function () {
                ...
                var e = BX.isAmPmMode(true);
                var t = e === BX.AM_PM_LOWER ? "g:i a" : e === BX.AM_PM_UPPER ? "g:i A" : "H:i";
                return BX.date.format([["tomorrow", "tomorrow, " + t], ["-", BX.date.convertBitrixFormat(BX.message("FORMAT_DATETIME")).replace(/:s/g, "")], ["s", "sago"], ["i", "iago"], ["today", "today, " + e], ["yesterday", "yesterday, " + e], ["", BX.date.convertBitrixFormat(BX.message("FORMAT_DATETIME")).replace(/:s/g, "")]], s, r, n)
            }, X: function () {
                var e = BX.isAmPmMode(true);
                var t = e === BX.AM_PM_LOWER ? "g:i a" : e === BX.AM_PM_UPPER ? "g:i A" : "H:i";
                var a = BX.date.format([["tomorrow", "tomorrow"], ["-", BX.date.convertBitrixFormat(BX.message("FORMAT_DATE"))], ["today", "today"], ["yesterday", "yesterday"], ["", BX.date.convertBitrixFormat(BX.message("FORMAT_DATE"))]], s, r, n);
                var i = BX.date.format([["tomorrow", t], ["today", t], ["yesterday", t], ["", ""]], s, r, n);
                if (i.length > 0) return BX.message("FD_DAY_AT_TIME").replace(/#DAY#/g, a).replace(/#TIME#/g, i); else return a
            }, Q: function () {
        ...
        function c(e, t, a, i) {
            ...
            for (var r = 0; r < e.length; r++) {
                ...
                } else if ((l = /^s(\d+)\>?(\d+)?/.exec(n)) != null) {
                    if (l[1] && l[2]) {
                        if (s < l[1] && s > l[2]) {
                            return BX.date.format(o, t, a, i)
                        }
                    } else if (s < l[1]) {
                        return BX.date.format(o, t, a, i)
                    }
                ...
                } else if ((l = /^i(\d+)\>?(\d+)?/.exec(n)) != null) {
                    if (l[1] && l[2]) {
                        if (s < l[1] * 60 && s > l[2] * 60) {
                            return BX.date.format(o, t, a, i)
                        }
                    } else if (s < l[1] * 60) {
                        return BX.date.format(o, t, a, i)
                ...
                } else if ((l = /^H(\d+)\>?(\d+)?/.exec(n)) != null) {
                    if (l[1] && l[2]) {
                        if (s < l[1] * 60 * 60 && s > l[2] * 60 * 60) {
                            return BX.date.format(o, t, a, i)
                        }
                    } else if (s < l[1] * 60 * 60) {
                        return BX.date.format(o, t, a, i)
                ...
                } else if ((l = /^d(\d+)\>?(\d+)?/.exec(n)) != null) {
                    if (l[1] && l[2]) {
                        if (s < l[1] * 24 * 60 * 60 && s > l[2] * 24 * 60 * 60) {
                            return BX.date.format(o, t, a, i)
                        }
                    } else if (s < l[1] * 24 * 60 * 60) {
                        return BX.date.format(o, t, a, i)
                    }
                } else if (n == "m") {
                    if (s < 365 * 24 * 60 * 60) return BX.date.format(o, t, a, i)
                } else if ((l = /^m(\d+)\>?(\d+)?/.exec(n)) != null) {
                    if (l[1] && l[2]) {
                        if (s < l[1] * 31 * 24 * 60 * 60 && s > l[2] * 31 * 24 * 60 * 60) {
                            return BX.date.format(o, t, a, i)
                        }
                    } else if (s < l[1] * 31 * 24 * 60 * 60) {
                        return BX.date.format(o, t, a, i)
                    }
                } else if (n == "now") {
                ...
                } else if (n == "tommorow" || n == "tomorrow") {
                    u = p(a);
                    _ = h(a);
                    c = d(a);
                    var B = i ? new Date(Date.UTC(u, _, c + 1, 0, 0, 0, 0)) : new Date(u, _, c + 1, 0, 0, 0, 0);
                    var v = i ? new Date(Date.UTC(u, _, c + 2, 0, 0, 0, 0)) : new Date(u, _, c + 2, 0, 0, 0, 0);
                    if (t >= B && t < v) return BX.date.format(o, t, a, i)
                } else if (n == "-") {
                    if (s < 0) return BX.date.format(o, t, a, i)
                }
            }
            return e.length > 0 ? BX.date.format(e[e.length - 1][1], t, a, i) : ""
        }
    ...
    BX.date.formatLastActivityDate = function (e, t, a) {
        var i = BX.isAmPmMode(true);
        var s = i === BX.AM_PM_LOWER ? "g:i a" : i === BX.AM_PM_UPPER ? "g:i A" : "H:i";
        var r = [["tomorrow", "#01#" + s], ["now", "#02#"], ["todayFuture", "#03#" + s], ["yesterday", "#04#" + s], ["-", BX.date.convertBitrixFormat(BX.message("FORMAT_DATETIME")).replace(/:s/g, "")], ["s60", "sago"], ["i60", "iago"], ["H5", "Hago"], ["H24", "#03#" + s], ["d31", "dago"], ["m12>1", "mago"], ["m12>0", "dago"], ["", "#05#"]];
        var n = BX.date.format(r, e, t, a);
        if ((match = /^#(\d+)#(.*)/.exec(n)) != null) {
            switch (match[1]) {
                case"01":
                    n = BX.message("FD_LAST_SEEN_TOMORROW").replace("#TIME#", match[2]);
                    break;
                case"02":
                    n = BX.message("FD_LAST_SEEN_NOW");
                    break;
                case"03":
                    n = BX.message("FD_LAST_SEEN_TODAY").replace("#TIME#", match[2]);
                    break;
                case"04":
                    n = BX.message("FD_LAST_SEEN_YESTERDAY").replace("#TIME#", match[2]);
                    break;
                case"05":
                    n = BX.message("FD_LAST_SEEN_MORE_YEAR");
                    break;
                default:
                    n = match[2];
                    break
        ...
        Init: function (e, t, a) {
            ...
            switch (s.value) {
                case"day":
                    ...
                    break;
                case"week":
                    n = new Date(u, _, c - p + 1 + r * 7, 0, 0, 0);
                    o = new Date(u, _, c + (7 - p) + r * 7, 23, 59, 59);
                    break;
                case"month":
                    ...
                    break;
                case"quarter":
                    var d = Math.floor(_ / 3) + r;
                    n = new Date(u, 3 * d, 1, 0, 0, 0);
                    o = new Date(u, 3 * (d + 1), 0, 23, 59, 59);
                    break;
                case"year":
        ...
        if (this.params.bSetFocus) {
            ...
            BX.bind(e.node, "keyup", BX.defer(function () {
                ...
                if (!!this.params.bTime) {
                    if (this.value.getUTCHours() <= 0 && this.value.getUTCMinutes() <= 0) BX.removeClass(this.PARTS.TIME, "bx-calendar-set-time-opened"); else BX.addClass(this.PARTS.TIME, "bx-calendar-set-time-opened")
                }
            }, this))
        }
        return this
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:48:"/bitrix/js/main/json/json2.min.js?14997573613467";s:6:"source";s:33:"/bitrix/js/main/json/json2.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:50:"/bitrix/js/main/core/core_ls.min.js?14997573607365";s:6:"source";s:31:"/bitrix/js/main/core/core_ls.js";s:3:"min";s:35:"/bitrix/js/main/core/core_ls.min.js";s:3:"map";s:35:"/bitrix/js/main/core/core_ls.map.js";}"*/
(function (e) {
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:45:"/bitrix/js/main/session.min.js?14997573602511";s:6:"source";s:26:"/bitrix/js/main/session.js";s:3:"min";s:30:"/bitrix/js/main/session.min.js";s:3:"map";s:30:"/bitrix/js/main/session.map.js";}"*/
function CBXSession() {
    var e = this;
    this.mess = {};
    this.timeout = null;
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:44:"/bitrix/js/main/utils.min.js?149975736019858";s:6:"source";s:24:"/bitrix/js/main/utils.js";s:3:"min";s:28:"/bitrix/js/main/utils.min.js";s:3:"map";s:28:"/bitrix/js/main/utils.map.js";}"*/
var phpVars;
if (!phpVars) {
    phpVars = {
